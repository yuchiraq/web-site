...
var seoDataByPath = map[string]SEOData{
	...
	"/services": {
		Title:       "Инженерные услуги в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/rent": {
		Title:       "Аренда спецтехники в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/contacts": {
		Title:       "Контакты ЧСУП АВАЮССТРОЙ | Брест",
	...
	"/services/drainage": {
		Title:       "Дренажные системы в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/services/plumbing": {
		Title:       "Водоснабжение в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/services/sewerage": {
		Title:       "Монтаж канализации в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/services/storm_sewer": {
		Title:       "Ливневая канализация в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/services/topas": {
		Title:       "Автономная канализация ТОПАС в Бресте | ЧСУП АВАЮССТРОЙ",
	...
	"/services/water_lowering": {
		Title:       "Водопонижение в Бресте и области | ЧСУП АВАЮССТРОЙ",
	...
	"/404": {
		Title:       "404 - Страница не найдена | ЧСУП АВАЮССТРОЙ",
